...
import json
            ...
            def get_balance(participant):
                ...
                """
                # Fetch a list of all sent coin amounts for the given person (empty lists are returned if the person wes NOT the sender)
                # This fetches sent amounts of transactions the were already included in blocks of the blockchain.
                ...
                # We ignore open transaction here because you shouldn't be able to spend coins before the transaction was confirmed + included in a block
            ...
            while waiting_for_input:
                ...
                if not verify_chain():
                    ...
                    break
                print('Balance of {name} : {balance:6.2f}'.format(name=owner,balance=get_balance(owner)))
            else:
                print('User left!')
